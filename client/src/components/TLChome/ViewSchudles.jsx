    ...
    <div className="d-flex flex-column min-vh-100">
      <div className="container my-4 flex-grow-1">
        <style>{`
          ...
          th, td { position: relative; text-align:center; vertical-align:middle; height:70px; border:1px solid #dee2e6; border-radius:10px; padding:0; overflow:hidden; }
          .subject-box {   position: absolute; width:100%; height:100%; display:flex; flex-direction:column; align-items:center; justify-content:center; font-weight:600; font-size:.9rem; white-space:normal; word-break:break-word; overflow:visible; text-align:center; padding:4px;  margin: 0;  }
