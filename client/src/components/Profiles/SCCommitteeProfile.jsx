  ...
  return (
    <div className="sc-prof" dir="ltr">
      ...
      <section className={`hero area-constrained ${includeHeader ? "" : "hero-top-pad"}`}>
        <div className="hero-inner">
          <div className="avatar-wrap">
            <div className="avatar-fallback"><span>SC</span></div>
        ...
        <svg className="wave" viewBox="0 0 1440 120" preserveAspectRatio="none" aria-hidden="true">
          <defs>
            <linearGradient id="scWave" x1="0%" y1="0%" x2="100%" y2="0%">
      ...
      <style>{`
        ...
        .sc-prof{ color:var(--ink); min-height:100vh; display:flex; flex-direction:column; }
