    ...
    async function fetchProfile() {
      try {
        ...
        setUser({
          ...
          role: data.role || "Teaching Load Committee (TLC)",
          department: data?.department?.name || "Teaching Load Committee",
        });
    ...
    <div className="sc-profile" dir="ltr">
      ...
      <section className="hero area-constrained">
        ...
        <svg className="wave" viewBox="0 0 1440 120" preserveAspectRatio="none" aria-hidden="true">
          ...
          <path d="M0,64 C240,100 480,40 720,64 C960,88 1200,76 1440,60 L1440,160 L0,160 Z" fill="url(#tlcGrad)"/>
        </svg>
      </section>
